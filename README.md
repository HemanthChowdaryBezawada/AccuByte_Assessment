...
- **Implementation**: I developed the core API logic myself. AI assisted by generating boilerplate code, speeding up the implementation of standard components, and helping write the code under my direction.
